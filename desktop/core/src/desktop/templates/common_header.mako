...
<div class="navigator">
  ...
  % endif
    ...
    <a class="brand nav-tooltip pull-left" title="${_('About Hue')}" rel="navigator-tooltip" href="/about"><img width="142" height="12" src="/static/art/powerlinx-lab-title.png" data-orig="/static/art/powerlinx-lab-title.png" data-hover="/static/art/hue-logo-mini-white-hover.png"/></a>
    % if user.is_authenticated() and section != 'login':
