...
<div class="navigator">
  ...
  % endif
    ...
    <a class="brand nav-tooltip pull-left" title="${_('About Hue')}" rel="navigator-tooltip" href="/about"><img src="/static/art/powerlinx-lab-title.png" data-orig="/static/art/powerlinx-lab-title.png" data-hover="/static/art/powerlinx-lab-title.png" /></a>
    % if user.is_authenticated() and section != 'login':
